...
The W_dec matrix of the SAE whose rows are the learned dictionary directions (features), used to span planes in feature-based arms.

## Source

SAE architecture; sae-lens
