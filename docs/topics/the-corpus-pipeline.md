...
Each [base point](../glossary/base-point.md) is a layer-12 [resid_post](../glossary/resid-post.md) activation vector extracted from a [WikiText-103](../glossary/wikitext-103.md) passage. The [corpus draw](../glossary/corpus-draw.md) procedure is fully deterministic: [article reconstruction](../glossary/article-reconstruction.md) joins raw WikiText rows between top-level headers into coherent articles, a seed-42 shuffle assigns [draw order](../glossary/draw-order.md), and the [survivor-targeted draw](../glossary/survivor-targeted-draw.md) continues until 240 candidates pass the 64-token filter.
